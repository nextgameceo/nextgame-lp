    ...
    <>
      <style>{`
        .ng-hero {
          ...
          padding: clamp(7rem, 13vw, 11rem) clamp(1.25rem, 6vw, 3rem) clamp(5rem, 8vw, 7rem);
      ...
      <section id="hero" className="ng-hero" aria-labelledby="hero-headline">
        <HeroCanvas />
        ...
        <div className="ng-hero-inner">
          ...
          <div className="ng-actions">
            <a href="#contact" className="ng-btn ng-btn-primary" role="button" aria-label="無料相談を予約する">
              <span>無料相談を予約する</span>
              <span className="ng-btn-arrow" aria-hidden="true">→</span>
            </a>
            <a href="#flow" className="ng-btn ng-btn-ghost" role="button" aria-label="サービスの流れを確認する">
              サービスの流れ
            </a>
          </div>
