          ...
          <div className={styles.sectionInner}>
            ...
            <div className={styles.sectionRight}>
              <p className={styles.sectionDescription}>
                ...
                {' '}
                契約した翔月から、動き続けるWebサイトへ。作って終わりではなく、毎日進化する資産として。
              </p>
              <div>
            ...
            <div className={styles.sectionInner}>
              ...
              <div className={styles.sectionRight}>
                <p className={styles.sectionDescription}>
                  ...
                  {' '}
                  弊社は従来の単純作業中心の作業所ではなく、利用者の皆様に工賞を支払いつつ、実際の業務を通じて、プロンプトエンジニアリングスキルをOJT教育し、経済的に自立が出来る支援を行います。{' '}
                  {' '}
                  またNEXTGAMEは、通所実績とスキルに応じて工賞が上がる仕組みを用意しています。{' '}
                  {' '}
            ...
            <div className={styles.sectionInner}>
              ...
              <div className={styles.sectionRight}>
                <p className={styles.sectionDescription}>
                  ...
                  {' '}
                  しかし多くのB型作業所では、平均工賞が月頤1万円前後に留まるなど、持続的な収益モデルの構築が大きな課題となっています。{' '}
                  {' '}
